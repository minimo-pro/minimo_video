...
Modular documentation for **minimo (video)**. It is written for developers and AI coding agents working in this repository.
...
The index uses `#[[file:path]]` references for AI-assisted navigation.
