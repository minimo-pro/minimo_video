...
const Changelog _changelog = {
  '1.0.7': {
    Language.en: [
      ...
      'import videos shared from other apps.',
    ],
    Language.ru: [
      ...
      'импортируйте видео, которыми поделились из других приложений.',
    ],
    Language.es: [
      ...
      'importa videos compartidos desde otras aplicaciones.',
    ],
    Language.pt: [
      ...
      'importe vídeos compartilhados por outros aplicativos.',
    ],
    Language.de: [
      ...
      'importiere Videos, die aus anderen Apps geteilt wurden.',
    ],
    Language.fr: [
      ...
      'importez des vidéos partagées depuis d’autres applications.',
    ],
    Language.zh: [
    ...
    Language.hi: [
      ...
      'दूसरे ऐप्स से शेयर किए गए वीडियो इंपोर्ट करें।',
    ],
    Language.nl: [
    ...
    Language.it: [
      ...
      'importa video condivisi da altre app.',
    ],
    Language.tr: [
      ...
      'diğer uygulamalardan paylaşılan videoları aktarın.',
    ],
  },
  '1.0.6': {
    Language.en: [
