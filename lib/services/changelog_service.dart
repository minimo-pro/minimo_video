...
const Changelog _changelog = {
  '1.0.7': {
    Language.en: [
      ...
      'import videos from iOS Shortcuts and the iOS or Android Share Sheet.',
    ],
    Language.ru: [
      ...
      'импортируйте видео из Команд iOS и системного меню «Поделиться» на iOS или Android.',
    ],
    Language.es: [
      ...
      'importa videos desde Atajos de iOS y el menú Compartir de iOS o Android.',
    ],
    Language.pt: [
      ...
      'importe vídeos pelos Atalhos do iOS e pelo menu Compartilhar do iOS ou Android.',
    ],
    Language.de: [
      ...
      'importiere Videos über iOS-Kurzbefehle und das Teilen-Menü von iOS oder Android.',
    ],
    Language.fr: [
      ...
      'importez des vidéos depuis Raccourcis iOS et le menu Partager iOS ou Android.',
    ],
    Language.zh: [
      '选择质量、均衡或更小；技术控制仍在高级设置中。',
      '现在会显示：处理仅在设备上完成、项目开源，节省不足 10% 时保留原视频。',
      '可从 iOS 快捷指令以及 iOS 或 Android 分享菜单导入视频。',
    ],
    Language.hi: [
      ...
      'iOS शॉर्टकट और iOS या Android शेयर मेन्यू से वीडियो इंपोर्ट करें।',
    ],
    Language.nl: [
      ...
      'importeer video’s via iOS Opdrachten en het deelmenu van iOS of Android.',
    ],
    Language.ko: [
      '화질, 균형 또는 더 작게를 선택하세요. 기술 옵션은 고급에 있습니다.',
      '기기 내 처리, 오픈 소스, 10% 미만 절약 시 원본 유지가 이제 표시됩니다.',
      'iOS 단축어와 iOS 또는 Android 공유 메뉴에서 동영상을 가져옵니다.',
    ],
    Language.ja: [
      '画質、バランス、より小さくから選択。技術設定は詳細にあります。',
      '端末上での処理、オープンソース、10%未満の節約では元動画を残すことを表示します。',
      'iOSショートカットとiOSまたはAndroidの共有メニューから動画を読み込めます。',
    ],
    Language.it: [
      ...
      'importa video da Comandi Rapidi iOS e dal menu Condividi di iOS o Android.',
    ],
    Language.tr: [
      ...
      'iOS Kestirmeleri ve iOS veya Android paylaşım menüsünden video aktarın.',
    ],
  },
  '1.0.6': {
    Language.en: [
