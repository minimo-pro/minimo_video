...
const Changelog _changelog = {
  '1.0.1': {
    Language.en: [
      ...
      'on iOS, choose how saved videos handle originals while preserving gallery metadata where supported.',
      'on Android, save compressed videos directly as new gallery items.',
      'on iOS, avoid replacing or deleting the same gallery video twice.',
    ...
    Language.ru: [
      ...
      'на iOS можно выбрать способ сохранения оригинала с переносом метаданных галереи, где это поддерживается.',
      'на Android сжатые видео сразу сохраняются как новые элементы галереи.',
      'на iOS приложение больше не заменяет и не удаляет одно видео повторно.',
